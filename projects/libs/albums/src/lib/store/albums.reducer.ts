...
const createAlbumsReducer = createReducer(
  initialState,
...
export const albumsReducer = (state: AlbumsState | undefined, action: Action): AlbumsState =>
  createAlbumsReducer(state, action);
