...
export const loadAlbum = createAction( '[ API/Albums ] Delete Album', props<{ album: Album }>() );
export const loadAlbumSuccess = createAction( '[ Api/Albums ] Load Albums Success', props<{ album: Album }>() );
export const loadAlbumFailure = createAction( '[ Api/Albums ] Load Albums Failure', props<{ error: any }>() );
